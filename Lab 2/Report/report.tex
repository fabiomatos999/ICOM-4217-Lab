...
\end{figure}
We were able to successfully able to intialize the LCD panel, display messages on both top and bottom displays, scroll through a list of strings on the display automatically and either scroll up or down using push buttons.
